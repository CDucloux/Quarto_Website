...
La carte `leaflet` de l'onglet **Nucléaire** présente la localisation et la puissance installée de l'ensemble des centrales nucléaires en exploitation en France. Il en existe actuellement 56 (à date du 8 mai 2024) réparties sur 18 **CNPE**^[Centre National de Production d'Electricité]. 
