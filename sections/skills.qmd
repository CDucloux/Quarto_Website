...
::: {.chevron-styling}
[{{< iconify pixelarticons:chevron-down size=5x >}}](#langages)
:::
...
- Je l'utilise aussi couplé à [`pre-commit`](https://pre-commit.com/) pour gérer et éxécuter des *hooks*^[Les *hooks* sont des scripts qui s’exécutent automatiquement à des moments précis du workflow sur Git.] avant chaque **commit** pour vérifier les vulnérabilités, reformater le code, etc.
:::
...
- Et surtout, adieu aux présentations **PowerPoint** grâce à [`reveal.js`](https://revealjs.com/).
:::
...
## {{< iconify ri:presentation-fill >}} Capacités de présentation et de vulgarisation
...
## {{< iconify mingcute:schedule-fill >}} Capacités organisationnelles
...
## {{< iconify iconoir:learning >}} Veille technologique
...
## {{< iconify flag:gb-4x3 >}} Anglais

Niveau C1 | **Score** au Listening and Reading *TOEIC®* : [920/990](https://www.etsglobal.org/fr/en/digital-score-report/D4B5ABF3DBEA351C234C144834847F0B8A0E6C9114584F656B7D23D2D3A6FA56bnc2ZjVpSE1ZNXlnVjFGV2ZWeVI4bE5GYitqL3MvTXFQaUlKb0p0eEVUREcxVk5p).
