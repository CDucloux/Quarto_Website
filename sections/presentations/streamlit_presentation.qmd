---
title: "💻 Streamlit"
subtitle: "*Boostez le développement de vos applis data !*"
author: "`Corentin DUCLOUX`"
categories: ["Python", "Streamlit"]
description: "Présentation du package `streamlit` et de ses fonctionnalités à la promotion de Master 2 *Mécen*."
date: 03-20-2024
date-format: DD/MM/YYYY
image: "streamlit_presentation/imgs/streamlit_mark.png"
title-slide-attributes:
    data-background-image: "streamlit_presentation/imgs/streamlit_mark.png"
...
format: 
    revealjs:
        ...
        logo: streamlit_presentation/imgs/mecen_logo.png
        css: streamlit_presentation/streamlit_custom_styles.css
---
...
![](streamlit_presentation/imgs/meme_columns.jpg){fig-align="center" width="35%"}
...
if prenom:
    with tab_1:
        if reussite:
            ...
            st.snow()
            st.write(
                f"**Aie**... 🥶 c'est un travail insuffisant *{prenom}*"
            )
```
...
![](streamlit_presentation/imgs/meme_polars.jpg){fig-align="center" width="75%"}
...
![](streamlit_presentation/imgs/meme_skeleton.jpeg){fig-align="center" width="35%"}
...
![](streamlit_presentation/imgs/cache_decorator.png){fig-align="center" width="75%"}
...
- 🍷 Projet de Machine Learning : [Wine Scraping](https://wine-scraping.streamlit.app/)
- 🚗 Projet de Machine Learning : [Esti*my*Car](https://estimycar.streamlit.app/)
...
![](streamlit_presentation/imgs/meme_end.jpg){fig-align="center" width="75%"}
...
![](streamlit_presentation/imgs/meme_cc.jpg){fig-align="center" width="40%"}
