...
Si *Bob* possède aussi d'autres fichiers dans son repository, et qu'il n'a pas envie de faire la même manipulation fichier par fichier, il peut utiliser `git add .` pour tout 
